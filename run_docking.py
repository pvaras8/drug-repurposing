...
def main() -> None:
    ...
    vina_hard_timeout = bool(vina_cfg.get("hard_timeout", False))
    vina_use_worker_map_cache = bool(vina_cfg.get("use_worker_map_cache", True))
    ...
    final_csv = run_pipeline(
        ...
        vina_hard_timeout=vina_hard_timeout,
        vina_use_worker_map_cache=vina_use_worker_map_cache,
